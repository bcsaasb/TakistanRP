...
Citizen.CreateThread(function()
	while true do
		...
		if nocauteado then
			if timedeath > 0 then
				drawTxt("Irmão, você está sangrando. Tens ~r~"..timedeath.." ~w~segundos de sangue ainda, chama os médicos logo ou é vala!",4,0.5,0.93,0.50,255,255,255,255)
			else
				drawTxt("Se precionar ~g~E ~w~ é vala! Melhor esperar um médico...",4,0.5,0.93,0.50,255,255,255,255)
			end
