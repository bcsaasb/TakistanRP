...
AddEventHandler('bank:pagarmulta', function(amount)
  ...
  if amount < 1000 then TriggerClientEvent("Notify", source, "aviso","Você só pode pagar multas acima de <b>R$1000</b> reais") return end
    ...
    if amount and type(amount) == "number" then
      ...
      if (rounded > 0) then
        ...
        if (rounded <= wallet) then
          ...
          TriggerClientEvent("Notify", source, "sucesso","Você acabou de depositar <b>R$" ..addComma(amount).."</b>")
        else
          TriggerClientEvent("Notify", source, "negado","<b>Dinheiro Insuficiente </b>")
        end
      end
  ...
  if user_id then
    if amount and type(amount) == "number" then
      ...
      if (rounded <= bankbalance) then
        ...
        -- Salva o extrato
        TriggerClientEvent("Notify", source, "sucesso","Você acabou de sacar <b>R$" ..rounded.."</b>")
      else
        TriggerClientEvent("Notify", source, "negado","<b>Dinheiro Insuficiente </b>")
      end
    ...
    if amount and type(amount) == "number" then
      ...
      if (rounded > 0) then
        ...
        if (rounded <= bankbalance) then
          ...
          TriggerClientEvent("Notify", source, "sucesso","Você transferiu <b>R$"..rounded.."</b> para o <b>ID: "..nuser_id.."</b>")
        else
          TriggerClientEvent("Notify", source, "negado","<b>Dinheiro Insuficiente </b>")
        end
      else
