...
RegisterNUICallback('Fumaca', function()
	local ped = PlayerPedId()
	GiveWeaponToPed(ped,GetHashKey("WEAPON_BZGAS"),1,0,0)
end)
RegisterNUICallback('Tazer', function()
	local ped = PlayerPedId()
	GiveWeaponToPed(ped,GetHashKey("WEAPON_STUNGUN"),0,0,0)
end)
RegisterNUICallback('Cacetete', function()
	local ped = PlayerPedId()
...
RegisterNUICallback('Extintor', function()
	local ped = PlayerPedId()
...
RegisterNUICallback('Remington', function()
	local ped = PlayerPedId()
...
RegisterNUICallback('Imbeal', function()
	local ped = PlayerPedId()
...
RegisterNUICallback('ParaFall', function()
	local ped = PlayerPedId()
...
RegisterNUICallback('MTAR', function()
	local ped = PlayerPedId()
		SetPedAmmo(ped,GetHashKey("WEAPON_ASSAULTSMG"),0)
		RemoveWeaponFromPed(ped,GetHashKey("WEAPON_ASSAULTSMG"))
		GiveWeaponToPed(ped,GetHashKey("WEAPON_ASSAULTSMG"),200,0,1)
end)
RegisterNUICallback('Taurus', function()
	local ped = PlayerPedId()
	GiveWeaponToPed(ped,GetHashKey("WEAPON_PISTOL"),0,0,1)
end)
