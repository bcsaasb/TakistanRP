...
Citizen.CreateThread(function()
	while true do
		...
		if andamento then
			...
			drawTxt(ui.right_x+0.230,ui.bottom_y-0.120,1.0,1.0,0.36,"APERTA ~r~M~w~ SE QUISER DESISTIR VACILAO",255,255,255,150,4)
			drawTxt(ui.right_x+0.230,ui.bottom_y-0.100,1.0,1.0,0.50,"AGUENTA AE, RESTA ~g~"..segundos.." SEGUNDOS ~w~PARA TERMINAR",255,255,255,255,4)
